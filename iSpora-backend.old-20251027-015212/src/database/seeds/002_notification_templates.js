  ...
  return knex('notification_templates').insert([
    {
      ...
      message_template:
        '{{member_name}} has joined your project "{{project_title}}". Review their profile and assign them to appropriate tasks.',
    ...
    },
    {
      ...
      message_template:
        'Great news! The milestone "{{milestone_title}}" has been completed in {{project_title}}. {{completion_message}}',
    ...
    },
    {
      ...
      message_template:
        'Your mentorship session with {{mentor_name}} is scheduled for {{session_date}} at {{session_time}}. Topic: {{session_topic}}',
      variables: JSON.stringify([
        'mentor_name',
        'session_date',
        'session_time',
    ...
    },
    {
      ...
      message_template:
        'Your application for "{{opportunity_title}}" at {{company_name}} has been {{status}}. {{status_message}}',
      variables: JSON.stringify([
        'opportunity_title',
        'company_name',
        'status',
    ...
    },
    {
      ...
      message_template:
        'You have successfully earned the "{{badge_name}}" badge! {{badge_description}}',
    ...
    },
    {
      ...
      message_template:
        'We will be performing scheduled maintenance on {{maintenance_date}} from {{start_time}} to {{end_time}}. The system may be temporarily unavailable during this time.',
