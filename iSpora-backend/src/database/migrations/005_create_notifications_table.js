exports.up = function(knex) {
  return knex.schema.createTable('notifications', table => {
    ...
    table.enu('type', ['connection', 'mentorship', 'project', 'opportunity', 'system', 'achievement']).notNullable();
    ...
    table.uuid('related_mentorship_id').references('id').inTable('mentorships').onDelete('SET NULL');
