  ...
  const projects = [
    {
      ...
      description: 'Building an adaptive learning platform that uses machine learning to personalize education.',
      detailed_description: 'This project aims to create a comprehensive learning platform that adapts to individual student needs using AI algorithms. The platform will track learning patterns, identify knowledge gaps, and provide personalized content recommendations.',
      ...
      skills_required: JSON.stringify(['Python', 'Machine Learning', 'React', 'Node.js', 'Database Design']),
    ...
    },
    {
      ...
      description: 'Developing technology solutions for environmental sustainability and social impact.',
      detailed_description: 'A collaborative project focused on creating innovative technology solutions that address environmental challenges. Teams will work on different aspects of sustainability including renewable energy, waste reduction, and carbon footprint tracking.',
      ...
      is_public: true,
      requires_approval: true,
      cover_image_url: 'https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?w=800&h=400&fit=crop',
      tags: JSON.stringify(['Sustainability', 'Innovation', 'Climate Tech', 'Social Impact']),
      skills_required: JSON.stringify(['Full Stack Development', 'Data Science', 'IoT', 'Mobile Development']),
      learning_objectives: JSON.stringify([
    ...
    },
    {
      ...
      description: 'Building a platform to analyze healthcare data and provide insights for better patient outcomes.',
      detailed_description: 'This project involves creating a comprehensive analytics platform for healthcare organizations to analyze patient data, identify trends, and improve treatment outcomes while ensuring strict privacy compliance.',
      ...
      skills_required: JSON.stringify(['Python', 'R', 'SQL', 'Data Visualization', 'Statistics', 'HIPAA Compliance']),
      learning_objectives: JSON.stringify([
  ...
  const mentorships = [
    {
      ...
      start_date: new Date('2024-01-15'),
      end_date: new Date('2024-06-15'),
      goals: 'Help Alex learn advanced software engineering practices and machine learning implementation in production environments.',
      ...
      mentor_notes: 'Alex is very motivated and picks up concepts quickly. Focus on best practices and code review.',
      mentee_notes: 'John is incredibly helpful and provides great insights into industry practices.',
      created_at: new Date(),
      updated_at: new Date()
    },
    {
      ...
      start_date: new Date('2024-02-01'),
      end_date: new Date('2024-08-01'),
      goals: 'Guide Maria in transitioning from academia to industry, focusing on product management and data science career paths.',
      meeting_schedule: JSON.stringify({
        frequency: 'bi-weekly',
        duration: 45,
        day: 'Friday',
      ...
      mentor_notes: 'Maria has strong technical skills but needs guidance on industry applications and career planning.',
