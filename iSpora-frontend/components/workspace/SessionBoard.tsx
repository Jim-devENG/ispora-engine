      ...
      <CardContent className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          <div className="flex items-center gap-1">
            ...
            <span className="truncate">{formatDate(session.scheduledDate)}</span>
          </div>
          <div className="flex items-center gap-1">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="capitalize truncate">{session.type}</span>
          </div>
          {session.location && (
            <div className="flex items-center gap-1">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex -space-x-2 flex-shrink-0">
            {session.attendees.slice(0, 8).map((attendee, index) => (
        ...
        <div className="flex items-center gap-2 pt-2 border-t flex-wrap">
          ...
          {session.status === 'upcoming' && (
            <Button variant="outline" onClick={() => onEdit(session)} className="flex-shrink-0">
              Edit
            </Button>
          )}
