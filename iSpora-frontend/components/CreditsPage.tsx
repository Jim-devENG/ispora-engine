    ...
    >
      ...
      <CardContent className="p-6">
        <div className="text-center space-y-4">
          <div
            className={`w-16 h-16 mx-auto rounded-full flex items-center justify-center ${badge.bgColor} ${badge.borderColor} border-2`}
          >
          ...
          <div>
            ...
            <div className="space-y-2">
              <Badge className={`${badge.color} text-white text-xs`} variant="default">
                {badge.rarity.toUpperCase()}
              </Badge>

              <div className="text-xs text-gray-500">{badge.points.toLocaleString()} points</div>
            </div>
          </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <Avatar className="h-10 w-10">
            ...
            <AvatarFallback>{((userInfo?.name || 'U').toString() || 'U').charAt(0)}</AvatarFallback>
          </Avatar>
      ...
      <CardContent className="p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between text-xs text-gray-600">
            ...
            <span>
              {nextLevelPoints.toLocaleString()} points to Level {currentLevel + 1}
            </span>
          </div>
        </div>
...
export function CreditsPage() {
  ...
  const shareData = {
    ...
    description:
      "I'm building impactful projects and connecting with amazing diaspora professionals. Join me on this journey!",
    ...
    const fetchAll = async () => {
      try {
        ...
        const [overviewRes, badgesRes, lbRes, actRes] = await Promise.all([
          ...
          fetch(`${API_BASE_URL}/credits/leaderboard?timeframe=${selectedTimeframe}`, {
            headers,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        {loading && <div className="text-center text-sm text-gray-500">Loading credits...</div>}
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-orange-600 text-sm mt-1 flex items-center gap-1">
                    ...
                    {badges.length
                      ? Math.round(
                          ((badges || []).filter((b: any) => b.earned).length / badges.length) *
                            100,
                        )
                      : 0}
                    % complete
                  ...
                  {[
                    ...
                    >
                      <div className="text-center space-y-3">
                        ...
                        <Badge className="bg-blue-600 text-white">Earn Now</Badge>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <CardContent>
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600">
                      Earn {POINT_VALUES.PLATFORM_INVITE} points for each successful referral. Help
                      grow the diaspora innovation community!
                    </p>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-700">
                            Get 300 points per successful invite
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-purple-700">
                            Progress towards Connector badge
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700">
                            Help fellow diasporans find opportunities
                          </p>
                        </div>
                      </div>
                    </div>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            navigator.clipboard.writeText(
                              'https://ispora.com/invite/amina-kone-2024',
                            );
                    ...
                    <div className="grid gap-4">
                      <div className="text-center p-4 bg-gray-50 rounded-lg">
                        <p className="text-2xl font-bold text-gray-900">
                          {userOverview?.referralsSuccessful || 0}
                        </p>
