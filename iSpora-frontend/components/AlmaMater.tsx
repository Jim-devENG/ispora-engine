...
const mockCampaigns = [
  ...
  },
  {
    ...
    description:
      'Mentor student entrepreneurs and help them develop business skills and tech solutions for local challenges.',
    type: 'mentorship',
    university: 'University of Lagos',
  ...
  },
  {
    ...
    description:
      'Intensive coding bootcamp for underprivileged students with job placement support.',
    type: 'education',
    university: 'Makerere University',
    admin: 'Dr. Amina Hassan',
  ...
  },
  {
    ...
    description:
      'Research and development of sustainable farming techniques for local communities.',
    type: 'research',
    university: 'Makerere University',
...
export function AlmaMater() {
  ...
  const handleActivityClick = (activity: any) => {
    ...
    const relatedCampaign = mockCampaigns.find((campaign) => campaign.title === activity.title);
  ...
  return (
    <div className="h-full">
      {/* Header */}
      <DashboardHeader userName="Dr. Amina" userTitle="Connecting with your alma mater community" />
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">
              Connect with your universities, create educational campaigns, and mentor the next
              generation
            </p>
          </div>
          <Button
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-2xl">
                    {mockImpactStats.totalStudentsReached.toLocaleString()}
                  </p>
                </div>
              </div>
            </CardContent>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Manage your university connections and view detailed information
                    </p>
                  </div>
                ...
                {quickActions.map((action) => (
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <div className={`flex-shrink-0 ${action.iconColor}`}>{action.icon}</div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {university.activeCampaigns} campaigns
                      </p>
                    </div>
                    <Badge variant="secondary" className="text-xs">
      ...
      {showConnectionDialog && (
        <AlmaMaterConnection onClose={() => setShowConnectionDialog(false)} />
      )}
      {showCreateCampaign && <CreateCampaign onClose={() => setShowCreateCampaign(false)} />}
      {showFindAlumni && <FindAlumni onClose={() => setShowFindAlumni(false)} />}
      {showJoinDiscussion && <JoinDiscussion onClose={() => setShowJoinDiscussion(false)} />}
      {showBrowseOpportunities && (
        <BrowseOpportunities onClose={() => setShowBrowseOpportunities(false)} />
      )}
    </div>
  );
}
