...
export function AlmaMater() {
  ...
  return (
    <div className="h-full">
      ...
      {/* Dialogs */}
      {showConnectionDialog && <AlmaMaterConnection onClose={() => setShowConnectionDialog(false)} />}
      ...
      {showBrowseOpportunities && <BrowseOpportunities onClose={() => setShowBrowseOpportunities(false)} />}
    </div>
  );
}
