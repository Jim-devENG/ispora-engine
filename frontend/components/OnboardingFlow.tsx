...
const diasporaSteps = [
  {
    ...
    content: {
      icon: Globe,
      description: 'As a diaspora member, you can make a real impact by sharing your knowledge, experience, and opportunities with ambitious young people in your home country.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: UserPlus,
      description: 'Your profile helps match you with the right mentees and projects. Showcase your expertise and what you\'re passionate about contributing.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: Users,
      description: 'Connect one-on-one with motivated students and young professionals. Use our workspace tools to conduct sessions, assign tasks, and track progress.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: Target,
      description: 'Start projects that address real challenges back home. From research initiatives to community programs, your leadership can drive meaningful change.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: Award,
      description: 'Share scholarships, job openings, internships, and other opportunities that can transform lives and careers.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: CheckCircle,
      description: 'You\'re all set to start making a difference. Welcome to a community of diaspora members committed to empowering the next generation.',
      features: [
...
const localSteps = [
  {
    ...
    content: {
      icon: GraduationCap,
      description: 'As a student or young professional, you can access mentorship, opportunities, and resources from successful diaspora community members worldwide.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: Star,
      description: 'Create a compelling profile that highlights your ambitions, skills, and what you\'re looking to achieve. This helps mentors find and connect with you.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: Heart,
      description: 'Browse profiles of diaspora mentors who match your interests and goals. Send connection requests to start meaningful mentorship relationships.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: Briefcase,
      description: 'Participate in projects led by diaspora mentors. Gain real-world experience while contributing to initiatives that matter.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: Zap,
      description: 'Stay updated on scholarships, internships, job opportunities, and other programs shared by our diaspora community.',
      features: [
  ...
  },
  {
    ...
    content: {
      icon: CheckCircle,
      description: 'You\'re ready to begin your journey with mentors, projects, and opportunities. Welcome to a community that\'s invested in your success.',
      features: [
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                className={`flex items-center gap-2 ${
                  userType === 'diaspora' ? 'bg-blue-600 hover:bg-blue-700' : 'bg-green-600 hover:bg-green-700'
                }`}
              >
    ...
    <Dialog open={state.showOnboarding} onOpenChange={() => {}}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0 gap-0">
        <DialogDescription className="sr-only">
          Complete the onboarding steps to get started with Aspora
        </DialogDescription>
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-3">
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
              ...
              {state.userType === 'diaspora' ? <Globe className="w-5 h-5" /> : <GraduationCap className="w-5 h-5" />}
            </div>
            <div>
              <h2 className="font-semibold">
                {state.userType === 'diaspora' ? 'Diaspora Member' : 'Student/Professional'} Onboarding
              </h2>
              <p className="text-sm text-gray-600">
                Get started with Aspora
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <Button 
              ...
              className="text-xs"
            >
              Switch to {state.userType === 'diaspora' ? 'Local User' : 'Diaspora'} 
            </Button>
