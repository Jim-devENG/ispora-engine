...
function StatCard({ 
  ...
  return (
    <Tooltip>
      <TooltipTrigger>
        <Card className={`hover:shadow-lg transition-all duration-500 transform card-hover-scale cursor-help ${
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-white rounded-lg border p-6">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <CardContent className="p-4 text-center">
                      <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                        <Search className="h-5 w-5 text-blue-600" />
                      </div>
                      <h3 className="font-medium text-gray-900 mb-1">Explore Projects</h3>
                  ...
                  >
                    <CardContent className="p-4 text-center">
                      <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                        <UserCheck className="h-5 w-5 text-green-600" />
                      </div>
                      <h3 className="font-medium text-gray-900 mb-1">Connect with Mentors</h3>
                  ...
                  >
                    <CardContent className="p-4 text-center">
                      <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                        <BookOpen className="h-5 w-5 text-purple-600" />
                      </div>
                      <h3 className="font-medium text-gray-900 mb-1">Discover Opportunities</h3>
                  ...
                  >
                    <CardContent className="p-4 text-center">
                      <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                        <Lightbulb className="h-5 w-5 text-orange-600" />
                      </div>
                      <h3 className="font-medium text-gray-900 mb-1">Start Your Initiative</h3>
                  ...
                  >
                    <CardContent className="p-4 text-center">
                      <div className="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
