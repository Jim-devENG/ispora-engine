...
const mockCampaigns: Campaign[] = [
  {
    ...
    description: "Connect with experienced engineers in the diaspora for career guidance, technical mentorship, and project collaboration opportunities.",
    type: "mentorship",
    ...
    requirements: ["Engineering student or recent graduate", "Active participation commitment", "Basic English proficiency"],
  ...
  },
  {
    ...
    description: "Funding initiative for student entrepreneurs developing solutions to local challenges. Get mentorship plus financial support for your startup idea.",
    type: "funding",
    university: "University of Lagos", 
  ...
  },
  {
    ...
    description: "Collaborative research project developing AI solutions for healthcare challenges in Africa. Work with international research teams.",
    type: "research",
  ...
  },
  {
    ...
    description: "Community project to develop and implement clean water solutions in rural areas. Engineering students and local communities working together.",
    type: "project",
  ...
  },
  {
    ...
    description: "Connect with fintech professionals working at leading companies. Perfect for students interested in financial technology careers.",
    type: "mentorship",
  ...
  },
  {
    ...
    description: "Research and development project focusing on sustainable farming techniques and crop optimization for smallholder farmers.",
    type: "research",
    ...
    requirements: ["Agricultural/Environmental science background", "Research commitment", "Field work availability"],
...
export function JoinExistingCampaigns({ isOpen, onClose, preSelectedUniversity = null }: JoinExistingCampaignsProps) {
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge variant="outline" className={statusColors[campaign.status]}>
                            ...
                            {campaign.status === "upcoming" && <Calendar className="h-3 w-3 mr-1" />}
                            {campaign.status === "ending-soon" && <Clock className="h-3 w-3 mr-1" />}
